 ...
 *  @author Kevin Wayne
 */
public final class StdDrawGraphGUI implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static StdDrawGraphGUI std = new StdDrawGraphGUI();
	...
	private static JMenuBar createMenuBar() {
		...
		JMenuItem item1 = new JMenuItem("Draw graph");
		JMenuItem item2 = new JMenuItem("Draw from file");
		JMenuItem item3 = new JMenuItem("Save to file");
		JMenuItem item4 = new JMenuItem("find Shortest path");
		JMenuItem item5 = new JMenuItem("find Shortest path distance");
		JMenuItem item6 = new JMenuItem("TSP enter all the nodes");
		JMenuItem item7 = new JMenuItem("TSP from file");
...
//				Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
	...
	private static Image getImage(String filename) {
		...
		if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
			URL url = StdDrawGraphGUI.class.getResource(filename);
			if (url != null)
				icon = new ImageIcon(url);
		}
	...
	public static void setG_GUI(g_GUI_new theG)
	{
		g= theG;
	}
...
//		}
	...
	public void mousePressed(MouseEvent e) {
		synchronized (mouseLock) {
			mouseX = StdDrawGraphGUI.userX(e.getX());
			mouseY = StdDrawGraphGUI.userY(e.getY());
			isMousePressed = true;
		}
	}
	 ...
	 */
	public static void main(String[] args) {
		StdDrawGraphGUI.square(0.2, 0.8, 0.1);
		StdDrawGraphGUI.filledSquare(0.8, 0.8, 0.2);
		StdDrawGraphGUI.circle(0.8, 0.2, 0.2);

		StdDrawGraphGUI.setPenColor(StdDrawGraphGUI.BOOK_RED);
		StdDrawGraphGUI.setPenRadius(0.02);
		StdDrawGraphGUI.arc(0.8, 0.2, 0.1, 200, 45);

		// draw a blue diamond
		StdDrawGraphGUI.setPenRadius();
		StdDrawGraphGUI.setPenColor(StdDrawGraphGUI.BOOK_BLUE);
		double[] x = { 0.1, 0.2, 0.3, 0.2 };
		double[] y = { 0.2, 0.3, 0.2, 0.1 };
		StdDrawGraphGUI.filledPolygon(x, y);

		// text
		StdDrawGraphGUI.setPenColor(StdDrawGraphGUI.BLACK);
		StdDrawGraphGUI.text(0.2, 0.5, "black text");
		StdDrawGraphGUI.setPenColor(StdDrawGraphGUI.WHITE);
		StdDrawGraphGUI.text(0.8, 0.8, "white text");
	}
